                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        student_detail["Gaurdian_Name"] ?? "No data found",
                                        style: GoogleFonts.poppins(
                                            fontSize: 22.sp,
                                            fontWeight: FontWeight.w600,
                                            color: Colors.black),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Text(
                                         student_detail ["First_Name"]?? "No data found",
                                          style: GoogleFonts.poppins(
                                              fontSize: 22.sp,
                                              fontWeight: FontWeight.w600,
                                              color: Colors.white),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              SvgPicture.asset(
                                "assets/icons/exam_icon.svg", width: 70.w,)
                            ],
                          ),
                          Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              SvgPicture.asset(
                                "assets/icons/books.svg", width: 70.w,)
                            ],
                          ),
                          Padding(
                            padding: EdgeInsets.only(top: 15.h),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              SvgPicture.asset(
                                "assets/icons/teacher_icon.svg", width: 70.w,)
                            ],
                          ),
                          Padding(
                            padding: EdgeInsets.only(top: 15.h),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              SvgPicture.asset(
                                "assets/icons/result_icon.svg", width: 70.w,)
                            ],
                          ),
                          Padding(
                            padding: EdgeInsets.only(top: 15.h),
